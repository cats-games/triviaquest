...
```
git remote add upstream https://github.com/hrr20-cats/hrr20-cats.git
```
...
- [ ] Did I cut my work branch off of master (don't cut new branches from existing branches)?
