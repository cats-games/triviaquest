...
game.itemGenerator(window.currentWorld, 4);
game.enemyGenerator(window.currentWorld, 0);
// enemyGenerator(mapData, 28);
// itemGenerator(mapData, 5);
game.map.loadTilesFromArrayString(window.currentWorld, mapCharToType, 'grass');
game.itemManager.loadFromArrayString(window.currentWorld, itemCharToType);
game.entityManager.loadFromArrayString(window.currentWorld, entityCharToType);
